...
public class ProfessorDAO extends Connect{
    ...
    public List<List<String>> selectProfessorInCollege(int collegeID) throws SQLException{
    ...
    public List<List<String>> searchProfessorInCollege(String column, String searchString, int collegeID) throws SQLException{
