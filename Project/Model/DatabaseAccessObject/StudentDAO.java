...
public class StudentDAO extends Connect{
    ...
    public String[][] searchStudentInCollege(String column, String searchString, int collegeID) throws SQLException{
