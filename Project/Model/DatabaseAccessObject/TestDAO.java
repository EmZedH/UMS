...
public class TestDAO extends Connect{
    ...
    public String[][] selectAllCourseTestOfStudent(int studentID, int courseID, int departmentID, int collegeID) throws SQLException {
    ...
    public String[][] selectStudentTest(int studentID, int studentSemester) throws SQLException {
