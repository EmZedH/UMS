...
public class SectionDAO extends Connect{
    ...
    public List<List<String>> selectSectionInCollege(int collegeID) throws SQLException {
    ...
    public List<List<String>> searchSectionInCollege(String column, String searchString, int collegeID) throws SQLException {
